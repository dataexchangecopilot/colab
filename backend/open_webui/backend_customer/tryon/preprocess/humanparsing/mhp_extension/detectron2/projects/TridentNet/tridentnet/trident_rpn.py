...
from open_webui.backend_customer.tryon.detectron2.modeling import PROPOSAL_GENERATOR_REGISTRY
from open_webui.backend_customer.tryon.detectron2.modeling.proposal_generator.rpn import RPN

...
import open_webui.backend_customer.tryon.detectron2.model_zoo as model_zoo
...
from open_webui.backend_customer.tryon.detectron2.structures import BitMasks, Boxes, ImageList, Instances

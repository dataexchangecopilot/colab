...
from open_webui.backend_customer.tryon.detectron2 import model_zoo
...
from open_webui.backend_customer.tryon.detectron2.data import DatasetCatalog
...
class TestCaffe2Export(unittest.TestCase):
    ...
    def _test_model(self, config_path, device="cpu"):
        ...
        from open_webui.backend_customer.tryon.detectron2.export import Caffe2Model, add_export_config, export_caffe2_model

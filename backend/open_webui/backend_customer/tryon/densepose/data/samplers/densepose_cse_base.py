...
from open_webui.backend_customer.tryon.detectron2.structures import Instances

from open_webui.backend_customer.tryon.densepose.converters.base import IntTupleBox
from open_webui.backend_customer.tryon.densepose.data.utils import get_class_to_mesh_name_mapping
from open_webui.backend_customer.tryon.densepose.modeling.cse.utils import squared_euclidean_distance_matrix
from open_webui.backend_customer.tryon.densepose.structures import DensePoseDataRelative
...
class DensePoseCSEBaseSampler(DensePoseBaseSampler):
    """
    Base DensePose sampler to produce DensePose data from open_webui.backend_customer.tryon.densepose predictions.

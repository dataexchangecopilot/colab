...
from open_webui.backend_customer.tryon.detectron2.structures import BitMasks, Instances

from open_webui.backend_customer.tryon.densepose.converters import ToMaskConverter


class MaskFromDensePoseSampler:
    """
    Produce mask GT from open_webui.backend_customer.tryon.densepose predictions

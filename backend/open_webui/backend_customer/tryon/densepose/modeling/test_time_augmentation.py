...
from open_webui.backend_customer.tryon.detectron2.data.transforms import RandomRotation, RotationTransform, apply_transform_gens
from open_webui.backend_customer.tryon.detectron2.modeling.postprocessing import detector_postprocess
from open_webui.backend_customer.tryon.detectron2.modeling.test_time_augmentation import DatasetMapperTTA, GeneralizedRCNNWithTTA
...
class DensePoseGeneralizedRCNNWithTTA(GeneralizedRCNNWithTTA):
    ...
    # the implementation follows closely the one from open_webui.backend_customer.tryon.detectron2/modeling

...
def collect_env_info():
    ...
    try:
        import open_webui.backend_customer.tryon.detectron2  # noqa
    ...
    try:
        import open_webui.backend_customer.tryon.detectron2._C as _C
...
def main() -> None:
    global x
    try:
        from open_webui.backend_customer.tryon.detectron2.utils.collect_env import collect_env_info as f

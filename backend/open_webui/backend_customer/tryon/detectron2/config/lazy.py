...
from open_webui.backend_customer.tryon.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from open_webui.backend_customer.tryon.detectron2.config import instantiate, LazyCall

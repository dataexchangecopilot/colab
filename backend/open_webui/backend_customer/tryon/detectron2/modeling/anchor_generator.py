...
from open_webui.backend_customer.tryon.detectron2.layers import ShapeSpec, move_device_like
from open_webui.backend_customer.tryon.detectron2.structures import Boxes, RotatedBoxes

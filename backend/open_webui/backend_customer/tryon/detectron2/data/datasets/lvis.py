...
from open_webui.backend_customer.tryon.detectron2.data import DatasetCatalog, MetadataCatalog
...
def main() -> None:
    ...
    import open_webui.backend_customer.tryon.detectron2.data.datasets  # noqa  # add pre-defined metadata
    import numpy as np
